  ...
  <div class="schedule-container">
    ...
    <div class="header-section">
      <div class="header-content">
        ...
        <p class="page-subtitle">查看和管理班级课程安排</p>
      </div>
    </div>
    ...
    <div class="query-card">
      ...
      <div class="query-form">
        ...
        <div class="form-group">
          ...
          <input v-model="className" placeholder="请输入班级名称" class="form-input" type="text" />
        </div>
        <button 
          @click="confirmInfo" 
          class="query-btn"
...
import { getTeacherCourseTable } from '@/api/admin/classcoursetable'
...
export default {
  ...
  methods: {
    async confirmInfo() {
      if (!this.semester || !this.className) {
        this.showToastMessage('请输入学期和班级名称', 'error')
        return
      }
