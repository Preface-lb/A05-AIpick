  ...
  <div class="schedule-container">
    ...
    <div class="info-card">
      <div class="info-header">
        <h2>课程表信息</h2>
        <span class="info-subtitle">请输入您要查询的的学院、专业和教师信息</span>
      </div>
      <div class="info-inputs">
        ...
        <div class="input-group">
          <label for="class">教师</label>
          <div class="input-wrapper">
            <input type="text" id="class" v-model="classInfo" placeholder="请输入教师姓名" />
            <span class="input-icon">👥</span>
          </div>
        </div>
